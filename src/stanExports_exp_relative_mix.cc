...
#include "stanExports_exp_relative_mix.h"

RCPP_MODULE(stan_fit4exp_relative_mix_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_exp_relative_mix")
