...
#include "stanExports_exp_relative_mix_full.h"

RCPP_MODULE(stan_fit4exp_relative_mix_full_mod) {


    class_<rstan::stan_fit<stan_model, boost::random::ecuyer1988> >("model_exp_relative_mix_full")
