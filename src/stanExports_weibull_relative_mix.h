...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(125, 6, "restart", "model_weibull_relative_mix");
    reader.add_event(223, 102, "end", "model_weibull_relative_mix");
    return reader;
}
